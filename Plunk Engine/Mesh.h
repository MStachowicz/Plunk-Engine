...
public:
	...
	// Draws the model on the currently set shader.
	void Draw()
	{
		// draw mesh
	...
	// Binds the textures of the model file on the shader and draws the model.
	void Draw(Shader shader)
	{
		...
		for (unsigned int i = 0; i < textures.size(); i++)
		{
			...
			if (name == "material.diffuseMap")
				number = std::to_string(diffuseNr++);
			else if (name == "material.specularMap")
